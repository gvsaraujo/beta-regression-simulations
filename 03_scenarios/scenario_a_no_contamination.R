# Scenario A: bounded beta densities, constant precision. No contamination.
...
for (n in sample_sizes) {
  ...
  cfg <- list(
    scenario_name = "Scenario A - no contamination",
    ...
    output_file = paste0("Results/scenario_a_no_contamination_n", n, ".txt")
  )
