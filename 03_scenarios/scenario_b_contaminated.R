# Scenario B: unbounded beta densities, constant precision. Contaminated.
# beta = (-1, -5.5), gamma = (5); mu in (0.001, 0.27), phi = exp(5) ~= 148.
# The 5% observations with the highest mu are replaced by draws with
# mu*_i = 0.002.
...
for (n in sample_sizes) {
  ...
  cfg <- list(
    scenario_name = "Scenario B - contaminated",
    ...
    output_file = paste0("Results/scenario_b_contaminated_n", n, ".txt")
  )
