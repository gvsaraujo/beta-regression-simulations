# Scenario B: unbounded beta densities, constant precision. No contamination.
...
for (n in sample_sizes) {
  ...
  cfg <- list(
    scenario_name = "Scenario B - no contamination",
    ...
    output_file = paste0("Results/scenario_b_no_contamination_n", n, ".txt")
  )
